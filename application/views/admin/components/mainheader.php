		 ...
		 <div class="col-sm-6 col-xs-7">		  
			...
			<ul class="user-info pull-left">          
			  <li class="profile-info dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img width="44" class="img-circle avatar" alt="" src="<?php echo base_url(); ?>assets/admin/images/man-3.jpg">John Henderson <span class="caret"></span></a>
